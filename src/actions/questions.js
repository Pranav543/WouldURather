...
import { ANSWER_A_POLL, ADD_QUESTION, UPDATE_QUESTIONS } from './actionTypes';
...
function handleAnswerPoll(answerObject) {
	return (dispatch) => {
		...
		return saveQuestionAnswer(answerObject).catch((e) => {
...
export { updateQuestions, handleAnswerPoll, handleAddQuestion };
